...
class RegisterManagerUseCase @Inject constructor(
    ...
    suspend operator fun invoke(token: String, managerRegisterDto: ManagerRegisterDto): Result<String> {
        return managerRepository.registerManager(token, managerRegisterDto)
    }
}
